              ...
              <Menu as="div" class="relative ml-3">
                <div>
                  <MenuButton class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <img class="h-8 w-8 rounded-full" src="../assets/cat.png" alt="" />
                  </MenuButton>
                </div>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
          <div class="flex items-center px-5">
            <div class="flex-shrink-0">
              <img class="h-10 w-10 rounded-full" src="../assets/cat.png" alt="" />
            </div>
            <div class="ml-3">
...
export default {
  components: { Disclosure, DisclosureButton, DisclosurePanel, Menu, MenuButton, MenuItem, MenuItems, Bars3Icon, XMarkIcon },
  ...
  setup() {
    ...
    return {
      user: computed(() => store.state.user.data || { name: '', email: '' }),
      navigation,
      logout
    }
  },
